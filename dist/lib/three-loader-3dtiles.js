...
class HB {
  ...
  */
  static async load(t) {
    ...
    let C, w, y;
    n.gltfLoader ? C = n.gltfLoader : (C = new Yc(), n.basisTranscoderPath && (w = new Zc(), w.detectSupport(i ?? new Xc()), w.setTranscoderPath(n.basisTranscoderPath + "/"), w.setWorkerLimit(1), C.setKTX2Loader(w)), n.dracoDecoderPath && (y = new $c(), y.setDecoderPath(n.dracoDecoderPath + "/"), y.setWorkerLimit(n.maxConcurrency), C.setDRACOLoader(y)));
    ...
    return {
      ...
      runtime: {
        ...
        setViewDistanceScale: (E) => {
          T.options.viewDistanceScale = E, T._frameNumber++, qe(T, l, r, ie);
        },
        setMaximumScreenSpaceError: (E) => {
          T.options.maximumScreenSpaceError = E, T._frameNumber++, qe(T, l, r, ie);
        },
        setHideGround: (E) => {
        ...
        overlayGeoJSON: (E, O) => {
          if (E.applyMatrix4(v), E.updateMatrixWorld(), !i)
            throw new Error("GeoJSON draping requires a renderer reference via LoaderProps");
          return BB(r, d, i, O), E.material.dispose(), E.material = jt, E;
        },
        setViewport: (E) => {
          r = E, Dt = null, zt = !0, lt && CB(r);
        },
        setRenderer: (E) => {
          i = E;
        },
        update: function(E, O) {
          if (ie = O, L += E, lt && EB(O), T && L >= o) {
            ...
            ot == null ? ot = new Y().copy(O.matrixWorld) : (zt || DB(O, ot)) && (L = 0, zt = !1, T._frameNumber++, O.getWorldPosition(ye), ot.copy(O.matrixWorld), qe(T, l, r, O));
          }
        },
        dispose: function() {
