...
|  [loadersGlGltf](./three-loader-3dtiles.loaderoptions.loadersglgltf.md) | boolean | When viewing b3dm (mesh) tiles, use the loaders.gl GLTFLoader rather than the Three.hs GLTFLoader - Default: <code>true</code>. |
