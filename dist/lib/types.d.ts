...
import { Object3D, Vector3, Material, Camera, WebGLRenderer, LoadingManager, Mesh, Points, Color } from 'three';
...
export type { LoaderProps, LoaderOptions, Runtime, GeoCoord, GeoJSONLoaderProps, FeatureToColor, DrapingShaderOptions, Viewport };
