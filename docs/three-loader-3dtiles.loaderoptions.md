...
|  [resetGeoTransform?](./three-loader-3dtiles.loaderoptions.resetgeotransform.md) | boolean | <i>(Optional)</i> Whether to reset any geo transformations and place the model at 0,0,0 - Default: <code>true</code> |
